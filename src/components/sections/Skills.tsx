...
const skills: Skill[] = [
  {
    ...
    Icon: Atom,
    tint: "#61dafb",
    note: "Hooks, Suspense, Server Components",
  },
  {
    name: "Next.js",
    level: 92,
        ...
        >
          {skills.map((skill) => (
            <motion.li
              ...
              className="group relative overflow-hidden rounded-2xl border border-slate-200 bg-white p-5 shadow-sm transition-shadow hover:shadow-[0_18px_40px_-15px_rgba(15,23,42,0.25)]"
            >
              {/* glow tint on hover */}
              <div
