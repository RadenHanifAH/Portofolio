...
const socials = [
  { label: "GitHub", href: "https://github.com/RadenHanifAH", Icon: Github },
  { label: "LinkedIn", href: "https://www.linkedin.com/in/radenhanif/", Icon: Linkedin },
  { label: "Instagram", href: "https://www.instagram.com/radenhnf/", Icon: Instagram },
];
...
export default function Contact() {
  ...
  function handleSubmit(e) {
    e.preventDefault();
    const mailtoUrl = `mailto:radenhanifabdulhakim67@gmail.com?subject=${encodeURIComponent(
      `Portofolio: Pesan dari ${form.name}`
      ...
      <div className="relative mx-auto max-w-7xl px-5 py-24 sm:px-8 sm:py-32 lg:px-12">
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-20">
          ...
          <div className="flex flex-col gap-6">
            ...
            <Reveal delay={0.25}>
              <a
                href="mailto:radenhanifabdulhakim67@gmail.com"
                className="group inline-flex w-fit items-center gap-3 text-lg font-semibold text-white transition-colors hover:text-lime"
              >
                ...
                radenhanifabdulhakim67@gmail.com
                <ArrowUpRight
                  size={18}
